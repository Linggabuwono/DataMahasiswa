...
public class DisplayMhs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        telephone = (EditText) findViewById(R.id.editTextTelephon);
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                telephone.setText((CharSequence) phon);
    ...
    {
        if (nomhs.getText().toString().equals("")||nama.getText().toString().equals("")||telephone.getText().toString().equals("")) {
            Toast.makeText(getApplicationContext(),
                    "Data Harus Diisi Semua!", Toast.LENGTH_LONG).show();
        }else {
            mydb.insertContact(nomhs.getText().toString(),nama.getText().toString(),telephone.getText().toString());
            Toast.makeText(getApplicationContext(),
